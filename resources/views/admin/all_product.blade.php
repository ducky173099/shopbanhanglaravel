                ...
                <tbody>
                    @foreach($all_product as $key => $product_pro)
                        <tr>
                            ...
                            <td><img src="public/uploads/product/{{ $product_pro->product_image}}" height="100" width="100""></td>
                            ...
                            <td>
                                <a href="{{URL::to('/edit-product/'.$product_pro->product_id)}}" class="active stylingEdit" ui-toggle-class="">
                                    <i class="fa fa-pencil-square-o text-success text-active"></i>
                                </a>
                                <a onclick="return confirm('Are you sure to delete')" href="{{URL::to('/delete-product/'.$product_pro->product_id)}}" class="active" ui-toggle-class="">
